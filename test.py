...
connection = psycopg2.connect(
    dbname="markets", user="postgres", password=f"{bd_password}", host="localhost"
)
...
produsers_insert = (
    "INSERT INTO produsers (produser_country,produser_company,prodused_date) VALUES "
)
categories_insert = "INSERT INTO categories (category_name) VALUES "
kivano_insert = (
    "INSERT INTO kivano (category_id, produser_id, product_name, price) VALUES "
)
sulpak_insert = (
    "INSERT INTO sulpak (category_id, produser_id, product_name, price) VALUES "
)
...
laptops = (
    ...
    (
        "MSI Thin",
        "MSI GL63 8RD",
        "MSI GF65 Thin 9SD 9S7-16W112-252",
        "MSI GL65 Leopard 10SCSR-051XRU 9S7-16U822-051",
        "MSI GF72VR 7RF",
    ),
    (
        "Acer A315-55G",
        "Acer A315-55G",
        "Acer Aspire E5-576G-74W4",
        "Acer Aspire E5-576G-74W4",
        "Acer Aspire A315-55G",
        "Acer Aspire E5-576G-56QV",
        "Acer Aspire E5-576G-5121",
        "Acer Aspire E5-576G-56QV",
        "Acer Aspire A315-55G",
        "Acer Extensa EX215-51-38HJ",
        "Acer Aspire 3 A315-42-R14W",
        "Acer Aspire E5-576G-56QV",
        "Acer Aspire E5-576G-5121",
    ),
    (
        ...
        "Lenovo V130-15IKB 81HN010YRU",
        "Lenovo Ideapad 320-15ISK",
        "Lenovo Flex 14 81SQ0000US",
        "Lenovo ThinkPad X390 20Q1SCDR00",
        "Lenovo V130-15IKB 81HN010YRU",
        "Lenovo Ideapad 320-15ISK",
    ),
)
...
categories = ("Smartphones", "Laptops", "Home Stuff", "Clothes")
...
dates = tuple(
    str(dt.date(dt.strptime(f"{rdt(1995,2023)}-{rdt(1,12)}-{rdt(1,29)}", "%Y-%M-%d")))
    for _ in range(SIZE)
)
